import BrandOne from '~/assets/images/avatar1.png'
import BrandTwo from '~/assets/images/avatar.png'
import BrandThree from '~/assets/images/avatar1.png'
import BrandFour from '~/assets/images/avatar.png'
import BrandFive from '~/assets/images/avatar1.png'
...
const TableOne = () => {
  return (
    <div className='rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1'>
      <h4 className='mb-6 text-xl font-semibold text-black dark:text-white'>Khách hàng</h4>
