...
import UserOne from '~/assets/images/avatar1.png'
import UserTwo from '~/assets/images/avatar.png'
import UserThree from '~/assets/images/avatar1.png'
import UserFour from '~/assets/images/avatar.png'
import UserFive from '~/assets/images/avatar1.png'
    ...
    <div className='col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4'>
      ...
      <div>
        {chatData.map((chat, key) => (
          <Link to='/' className='flex items-center gap-5 py-3 px-7.5 hover:bg-gray-3 dark:hover:bg-meta-4' key={key}>
