...
const SearchPage = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col  items-center bg-white'>
      <div className='flex flex-col justify-center items-center mt-4 select-none'>
      ...
      <div className='w-full flex justify-center'>
        ...
        <input className='border rounded-3xl shadow-lg px-10 py-2 w-[90%] md:w-[50%]' placeholder='Tìm kiếm' />
      </div>
    </div>
  )
}
